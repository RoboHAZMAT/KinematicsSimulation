...
plot3([shoulder(1,1),elbow(1,1),upperArmOri(1,1)],...
    [shoulder(1,2),elbow(1,2),upperArmOri(1,2)],...
    [shoulder(1,3),elbow(1,3),upperArmOri(1,3)],...
    '--','LineWidth',LW,'Color',[1 0 0],'Marker','.',...
    'MarkerEdgeColor',[1 0 0],'MarkerSize',MS);
plot3([elbow(1,1),wrist(1,1),hand(1,1)],...
    [elbow(1,2),wrist(1,2),hand(1,2)],...
    [elbow(1,3),wrist(1,3),hand(1,3)],...
    '--','LineWidth',LW,'Color',[1 0 0],'Marker','.',...
    'MarkerEdgeColor',[1 0 0],'MarkerSize',MS);
drawnow